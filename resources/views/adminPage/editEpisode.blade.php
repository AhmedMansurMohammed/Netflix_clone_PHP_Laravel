...
@section('content')
    ...
    <div class="container">
            ...
            <h1 class="m-5 text-center">UPDATE EPISODE</h1>
        ...
        <form action="{{ route('media.insert.episode') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="title" value="{{ $episode->title }}" name="title">
            </div>
            <div class="mb-3">
            ...
            <div class="form-group">
                ...
                <input type="url" name="url" id="url" value="{{ $episode->url }}" class="form-control">
            </div>
            <div class="form-group">
                <label for="duration">Duration(min):</label>
                <input type="number" name="duration" id="duration" value="{{ $episode->duration }}"
                    class="form-control">
            </div>
